        ...
        <div className="bg-slate-50 dark:bg-slate-600 max-w-full p-5 m-2 mb-1">
          <div className="flex justify-between items-center space-x-4">
            <img
              ...
              className="w-10 h-10"
            ></img>
            <div className="space-x-4">{/* Your other content here */}</div>
        ...
        <div className="bg-slate-50 dark:bg-slate-600 flex flex-col-reverse md:flex-row">
          <div className="md:w-1/2 rounded-lg bg-slate-50 dark:bg-slate-600 p-4 px-4 py-5 lg:p-6 m-6 dark:from-black dark:to-slate-600 text-gray-200">
            ...
            <p className="font-mono text-lg m-2 p-2 text-justify text-slate-400 dark:text-gray-400 xl:text-justify">
              I'm an Informatics at Atma Jaya Yogyakarta University with a high
              interest learner and ambitious. Currently learning and exploring
              Web Development. Experienced in managing organizational members
              and ensuring all members carry out tasks according to the division
              that has been given in order to achieve the organization's vision
              and mission by became vice-chairman for Himpunan Mahasiswa
              Informatika UAJY.
            </p>
            <div>
              <div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-between items-center">
                <div className="md:w-1/2">
                  <h1 className="text-lg font-mono text-slate-600 dark:text-gray-300 font-medium text-center mt-4 xl:text-xl">
                    My Social Media
                  </h1>
                  ...
                  <div className="text-center items-center m-2 ">
                    ...
                    <a
                      href="https://www.linkedin.com/in/wahyusutantopamungkas/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <IconButton
                        text="Linkedin"
                        color="bg-blue-500 dark:bg-gradient-to-tr dark:from-gray dark:to-blue-950"
                      >
                        <Linkedin size={20} />
                      </IconButton>
                    </a>
                    ...
                    >
                      <IconButton
                        text="/pamoenqkas_"
                        color="bg-gradient-to-tr from-yellow-500 to-purple-500 via-pink-500 dark:bg-gradient-to-tr dark:from-gray-500 dark:to-slate-800"
                      >
                        <Instagram size={20} />
                      </IconButton>
                    </a>
                ...
                <div className="md:w-1/2">
                  ...
                  <div className="text-center items-center m-2">
                    ...
                    <a href="mailto:wahyusutantop@gmail.com">
                      <IconButton
                        text="Contact"
                        color="bg-pink-500 dark:bg-gray-700 text-white dark:text-gray-100 "
                      >
                        <Mail size={20} />
                      </IconButton>
                    </a>
          ...
          <div className="flex md:w-1/2">
            ...
            {/* Kanan */}
            <div className="hidden md:flex justify-center items-center px-4 py-4 mx-4 my-4">
              <div className="my-8 bg-gradient-to-bl rounded-full from-blue-200 to-pink-500 dark:from-slate-600 dark:to-black w-24 h-24 justify-center items-center animate-bounce-reverse  "></div>
            </div>
          </div>
        </div>
      </div>
