...
const ProjectCard = ({
  ...
  return (
    ...
    <div className="max-w-2xl xl:max-w-6xl flex items-center justify-center mx-6 xl:mx-auto xl:h-auto rounded-2xl bg-[#8EE4AF] dark:bg-[#072E33] m-5  ">
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="md:w-1/2 p-2">
          <div className="text-center dark:text-[#EDF5E1] text-[#05386B] font-bold text-3xl align-middle xl:p-4 xl:m-2 p-2 m-2">
            {title}
          </div>
          <div className=" text-xl dark:text-[#EDF5E1] text-[#05386B] align-middle xl:p-4 xl:m-5 p-2 m-2 text-justify">
            {description}
          </div>
