...
const ProjectCard = ({
  ...
  return (
    ...
    <div className="scroll-smooth focus:scroll-auto max-w-2xl xl:max-w-6xl flex items-center justify-center mx-6 xl:mx-auto xl:h-auto rounded-2xl bg-slate-500 m-5  ">
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="md:w-1/2 p-2">
          <div className="text-center font-bold text-3xl align-middle xl:p-4 xl:m-2 p-2 m-2">
            {title}
          </div>
          <div className=" text-xl align-middle xl:p-4 xl:m-5 p-2 m-2 text-justify">
            {description}
          </div>
          <div class="flex flex-row items-center justify-center">
            <div class="w-full">
              <div className="text-center font-bold text-xl">What I used</div>
